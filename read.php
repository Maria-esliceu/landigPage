    ...
    <?php
        ...
        while($row = $result->fetch_assoc()){
            ...
            <div class="fila <?=$paridad?>">
                    ...
                    <a href="borrar.php?id=<?=$row['id']?>"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-trash-x" alt="Borrar" width="30" height="30" viewBox="0 0 24 24" stroke-width="2" stroke="rgb(72, 53, 150)" fill="none" stroke-linecap="round" stroke-linejoin="round" alt="BORRAR">
